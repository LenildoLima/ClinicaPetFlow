...
if (startIdx !== -1 && endIdx !== -1) {
    ...
    // Backtracking a bit to make sure we replace the containing div correctly?
    // Wait, let's just replace from `<Dialog open={isNewCobrancaOpen} onOpenChange={setIsNewCobrancaOpen}>` to `</Dialog>\n`
    content = content.substring(0, startIdx) + newBtn + content.substring(endIdx + 11);
